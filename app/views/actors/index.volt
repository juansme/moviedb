...
<div class="text-center">
	<button data-toggle="popup" data-target="#create" class="btn btn-primary">Crear actor</button>
</div>
<div class="table-responsive">
    <table class="table table-hover" id="DataTable" data-url="{{ url("actors/get") }}">
        <thead>
          	<tr>
          		<th></th>
            	<th>Nombre</th>
...
<div class="popup" id="create">
    <div class="panel panel-default">
        ...
        <div class="panel-body scroll-hidden">
        	<form class="ajax" data-action="{{ url("actors/create") }}">
...
<div class="popup" id="edit">
    <div class="panel panel-default">
        ...
        <div class="panel-body scroll-hidden">
        	<form class="ajax" data-action="{{ url("actors/update") }}">
